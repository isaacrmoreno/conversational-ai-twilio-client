          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Textarea
                id="prompt"
                name="prompt"
                defaultValue="Your calling your friend Riley Shimp just to check in and say whats up, if he ask this is Isaacs ai assistant."
